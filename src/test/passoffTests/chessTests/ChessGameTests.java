...
public class ChessGameTests {
    ...
    @Test
    @DisplayName("Normal Make implementation.Move")
    ...
    @Test
    @DisplayName("Invalid Make implementation.Move")
    ...
    @DisplayName("srcCode.Pawn Promotion")
    ...
    @Test
    @DisplayName("Full implementation.Game Checkmate")
    ...
    @Nested
    @DisplayName("Valid implementation.Move Tests")
    public class ValidMoveTests {
        ...
        @Test
        @DisplayName("implementation.Piece Partially Trapped")
        ...
        @Test
        @DisplayName("implementation.Piece Completely Trapped")
        ...
        @Test
        @DisplayName("King Cannot implementation.Move Into Check")
