...
public class KnightMoveTests {
    ...
    @Test
    @DisplayName("Middle of implementation.Board")
    ...
    @Test
    @DisplayName("implementation.Board Edge")
    ...
    @Test
    @DisplayName("implementation.Board Corner")
    ...
    public void allyPieces() {
        ...
        for (ChessPosition allyPiece : allyPiecePositions) {
            ...
            Assertions.assertFalse(pieceMoves.contains(badCapture),
                    "implementation.Piece moves contained invalid move: " + badCapture + " that would capture a ally piece");
        }
